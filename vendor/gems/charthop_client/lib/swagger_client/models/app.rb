...
module SwaggerClient
  class App
    ...
    def hash
      [id, org_id, name, redirect_uris, allowed_ips, config_fields, title, summary, description, setup_instructions, cron_order, cron_schedule, image_path, wordmark_image_path, status, min_access, event_notify_url, payload, events, type, bundle, scopes, tags, create_id, create_at, update_id, update_at, delete_id, delete_at].hash
    end
