...
module SwaggerClient
  class SearchResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'searchFields')
        if (value = attributes[:'searchFields']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @search_fields.nil?
        invalid_properties.push('invalid value for "search_fields", search_fields cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @search_fields.nil?
    ...
    def hash
      [entity, entity_id, entity_type, search_fields, score, name, description, image_path].hash
    end
