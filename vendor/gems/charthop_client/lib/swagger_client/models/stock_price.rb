...
module SwaggerClient
  class StockPrice
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['COMMON_FMV', 'FUNDRAISE', 'GRANT', 'PUBLIC'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['COMMON_FMV', 'FUNDRAISE', 'GRANT', 'PUBLIC'])
    ...
    def hash
      [id, org_id, stock, date, price, type, total, update_at, update_id].hash
    end
