...
module SwaggerClient
  class PartialField
    ...
    def hash
      [id, org_id, name, label, description, question, readonly, in_use, expr, type, values, default_value, options, entity_type, sensitive, hide_expr, expire_days, status, create_id, create_at, update_id, update_at, delete_id, delete_at].hash
    end
