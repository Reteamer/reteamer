...
module SwaggerClient
  class FormStatusUpdateRequest
    ...
    def list_invalid_properties
      ...
      if @form_ids.nil?
        invalid_properties.push('invalid value for "form_ids", form_ids cannot be nil.')
      end
    ...
    def valid?
      ...
      update_status_validator = EnumAttributeValidator.new('String', ['ACTIVE', 'INACTIVE', 'TODO', 'ARCHIVED'])
      return false unless update_status_validator.valid?(@update_status)
      return false if @form_ids.nil?
      true
    end
