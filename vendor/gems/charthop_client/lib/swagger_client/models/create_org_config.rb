...
module SwaggerClient
  class CreateOrgConfig
    ...
    def list_invalid_properties
      ...
      if @hidden_field_ids.nil?
        invalid_properties.push('invalid value for "hidden_field_ids", hidden_field_ids cannot be nil.')
      end

      if @built_in_category_map.nil?
        invalid_properties.push('invalid value for "built_in_category_map", built_in_category_map cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @hidden_field_ids.nil?
      return false if @built_in_category_map.nil?
      true
    end
    ...
    def hash
      [org_id, hidden_field_ids, built_in_category_map].hash
    end
