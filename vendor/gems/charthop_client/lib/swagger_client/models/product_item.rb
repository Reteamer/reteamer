...
module SwaggerClient
  class ProductItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'stripePriceId')
        self.stripe_price_id = attributes[:'stripePriceId']
      end
      ...
      if attributes.has_key?(:'minQty')
        self.min_qty = attributes[:'minQty']
      end

      if attributes.has_key?(:'fixedQty')
        self.fixed_qty = attributes[:'fixedQty']
      end
    ...
    def list_invalid_properties
      ...
      if @stripe_price_id.nil?
        invalid_properties.push('invalid value for "stripe_price_id", stripe_price_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @stripe_price_id.nil?
    ...
    def hash
      [product_id, stripe_price_id, qty, min_qty, fixed_qty, filter].hash
    end
