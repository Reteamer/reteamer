...
module SwaggerClient
  class ActionStep
    ...
    # If the action is MESSAGE, the target to send the message to. If the action is FORM, the person who should have the form filled out on
    attr_accessor :target

    # If the action is FORM, the user who should fill out the form (default is, same as target)
    attr_accessor :assign_todo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'assignTodo')
        self.assign_todo = attributes[:'assignTodo']
      end
      ...
      if attributes.has_key?(:'httpUrl')
        self.http_url = attributes[:'httpUrl']
      end
      ...
      if attributes.has_key?(:'httpHeaders')
        if (value = attributes[:'httpHeaders']).is_a?(Hash)
          self.http_headers = value
        end
      end

      if attributes.has_key?(:'httpContent')
        self.http_content = attributes[:'httpContent']
      end
    end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['FORM', 'MESSAGE', 'HTTP'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['FORM', 'MESSAGE', 'HTTP'])
    ...
    def hash
      [type, form_id, target, assign_todo, message, sensitive, http_url, http_method, http_headers, http_content].hash
    end
