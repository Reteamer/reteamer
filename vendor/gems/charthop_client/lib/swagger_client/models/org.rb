...
module SwaggerClient
  class Org
    ...
    attr_accessor :destroy_at

    # user who marked the org for data destruction
    attr_accessor :destroy_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'headJobId')
        self.head_job_id = attributes[:'headJobId']
      end
      ...
      if attributes.has_key?(:'activeUserCount')
        self.active_user_count = attributes[:'activeUserCount']
      end
      ...
      if attributes.has_key?(:'destroyAt')
        self.destroy_at = attributes[:'destroyAt']
      end

      if attributes.has_key?(:'destroyId')
        self.destroy_id = attributes[:'destroyId']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          destroy_at == o.destroy_at &&
          destroy_id == o.destroy_id
    end
    ...
    def hash
      [id, customer_id, name, slug, type, industry, est_employees, est_revenue, founded_year, address, phone, email, url, domains, status, image_path, currencies, stock, timezone, app_time, zone, fiscal_start, head_job_id, start_date, sensitive_fields, options, internal_options, onboard_steps, onboarding, self_serve_importing, head_count, user_count, active_user_count, active_at, change_at, create_id, create_at, update_id, update_at, destroy_at, destroy_id].hash
    end
