...
module SwaggerClient
  class PartialReport
    ...
    def valid?
      share_validator = EnumAttributeValidator.new('String', ['NORMAL', 'FULL'])
    ...
    def share=(share)
      validator = EnumAttributeValidator.new('String', ['NORMAL', 'FULL'])
    ...
    def hash
      [id, org_id, label, description, filter, share, sensitive, share_access, create_id, create_at, update_id, update_at, delete_id, delete_at].hash
    end
