...
module SwaggerClient
  class PartialReportChart
    ...
    # query for all series in the chart
    attr_accessor :query
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['LINE', 'AREA', 'STACKED', 'BAR', 'PIE', 'TABLE', 'TABLE_CROSSTAB'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['LINE', 'AREA', 'STACKED', 'BAR', 'PIE', 'TABLE', 'TABLE_CROSSTAB'])
    ...
    def hash
      [id, org_id, report_id, label, type, query, sort, create_id, create_at, update_id, update_at, delete_id, delete_at].hash
    end
