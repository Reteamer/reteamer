...
module SwaggerClient
  class Invoice
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'hostedInvoiceUrl')
        self.hosted_invoice_url = attributes[:'hostedInvoiceUrl']
      end

      if attributes.has_key?(:'invoicePdf')
        self.invoice_pdf = attributes[:'invoicePdf']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['PAID', 'UNPAID', 'VOID'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['PAID', 'UNPAID', 'VOID'])
    ...
    def hash
      [number, amount, hosted_invoice_url, invoice_pdf, status, create_at].hash
    end
