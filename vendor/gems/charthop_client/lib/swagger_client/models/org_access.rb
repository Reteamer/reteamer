...
module SwaggerClient
  class OrgAccess
    ...
    def valid?
      ...
      access_validator = EnumAttributeValidator.new('String', ['NONE', 'VIEW', 'LIMITED', 'MEMBER_LIMITED_COMP', 'MEMBER', 'TECH_OWNER', 'TIMEOFF', 'CONTACT', 'COMP_CASH', 'COMP_EQUITY', 'COMP_ALL', 'RECRUIT_SENSITIVE', 'RECRUIT_PRIMARY', 'PEOPLE_PARTNER', 'SENSITIVE_LIMITED_COMP', 'SENSITIVE', 'PRIMARY', 'OWNER'])
    ...
    def hash
      [org_id, person_id, access, group_ids, expr, expire_at].hash
    end
