...
module SwaggerClient
  class UpdateApp
    ...
    def list_invalid_properties
      ...
      if !@name.nil? && @name !~ Regexp.new(/^[a-z0-9-]+$/)
    ...
    def valid?
      return false if !@name.nil? && @name !~ Regexp.new(/^[a-z0-9-]+$/)
    ...
    def hash
      [name, redirect_uris, allowed_ips, config_fields, title, summary, description, setup_instructions, cron_order, cron_schedule, image_path, wordmark_image_path, status, min_access, event_notify_url, payload, events, type, bundle, scopes, tags].hash
    end
