...
module SwaggerClient
  class FormCollectRequest
    # the goal id that this form collection request aligns to (for example a performance review cycle)
    ...
    attr_accessor :relationship_filter
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'relationshipFilter')
        self.relationship_filter = attributes[:'relationshipFilter']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          goal_id == o.goal_id &&
          filter == o.filter &&
          relationship_filter == o.relationship_filter &&
          message == o.message &&
          preview == o.preview
    end
    ...
    def hash
      [goal_id, filter, relationship_filter, message, preview].hash
    end
