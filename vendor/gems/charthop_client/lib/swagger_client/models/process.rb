...
module SwaggerClient
  class Process
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'logPath')
        self.log_path = attributes[:'logPath']
      end
    ...
    def hash
      [id, org_id, label, type, status, file_path, log_path, run_user_id, parent_process_id, create_id, create_at, update_id, update_at, start_at, end_at, message, progress, internal_error, options, results, log_data_list, state, app_id].hash
    end
