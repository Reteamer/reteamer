  ...
  class DataView
    ...
    def self.swagger_types
      {
        ...
        :'columns' => :'String',
        :'type' => :'String',
        :'column_widths' => :'Hash<String, Float>',
        :'date' => :'String',
        :'filter' => :'String',
        :'sort' => :'String',
        :'group_by' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'columnWidths')
        if (value = attributes[:'columnWidths']).is_a?(Hash)
      ...
      if attributes.has_key?(:'groupBy')
        self.group_by = attributes[:'groupBy']
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['ANY', 'DATA_SHEET', 'ORG_CHART', 'MAP'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['ANY', 'DATA_SHEET', 'ORG_CHART', 'MAP'])
    ...
    def hash
      [id, org_id, name, slug, columns, type, column_widths, date, filter, sort, group_by, share_access, sensitive, create_id, create_at, update_id, update_at, delete_id, delete_at].hash
    end
