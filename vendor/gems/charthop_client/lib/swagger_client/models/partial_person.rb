...
module SwaggerClient
  class PartialPerson
    ...
    def hash
      [id, org_id, user_id, name, contacts, address, remote_work_address, birth_date, start_date, end_date, image_path, name_audio_path, gender, ethnicity, fields, sensitive_fields, sort, create_id, create_at, update_id, update_at].hash
    end
