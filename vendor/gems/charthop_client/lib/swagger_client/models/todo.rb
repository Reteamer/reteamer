...
module SwaggerClient
  class Todo
    ...
    # user who is responsible for the todo
    attr_accessor :user_id

    # parent goal id that this todo belongs to
    attr_accessor :goal_id

    # type of todo
    attr_accessor :type

    # the primary entity being referenced by the todo - for example for a FORM_SUBMIT, this will be the form
    attr_accessor :entity_id

    # the optional target entity being referenced by the todo - for example for a FORM_SUBMIT, this will be the person
    attr_accessor :target_id

    # status of this todo - PENDING or DONE
    attr_accessor :status

    # timestamp that the todo was done, if it was done
    ...
    # The message attached to this todo
    attr_accessor :message

    # users who are specifically granted permission to view or edit this Todo
    attr_accessor :share_access

    # the optional path of this todo (only applies to Type == ORG_IMPORT)
    attr_accessor :path
    ...
    def hash
      [id, org_id, user_id, goal_id, type, entity_id, target_id, status, done_at, create_id, create_at, message, share_access, path, update_id, update_at, delete_id, delete_at].hash
    end
