...
module SwaggerClient
  class Form
    ...
    def hash
      [id, org_id, label, description, fields, blocks, status, type, sensitive, approval, author_sensitive, options, create_id, create_at, update_id, update_at, delete_id, delete_at].hash
    end
