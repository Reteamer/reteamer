...
module SwaggerClient
  class TimeOff
    ...
    def valid?
      ...
      approval_validator = EnumAttributeValidator.new('String', ['APPROVED', 'PENDING', 'CANCELLED', 'REJECTED', 'SUPERSEDED'])
    ...
    def approval=(approval)
      validator = EnumAttributeValidator.new('String', ['APPROVED', 'PENDING', 'CANCELLED', 'REJECTED', 'SUPERSEDED'])
    ...
    def hash
      [id, start_date, end_date, days, hours, type, note, approval].hash
    end
