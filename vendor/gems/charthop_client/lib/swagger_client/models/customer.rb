...
module SwaggerClient
  class Customer
    ...
    # custom plan annual amount, if it is not being tracked on Stripe
    attr_accessor :custom_plan_annual
    ...
    attr_accessor :projected_arr

    # options, including fteOnly
    attr_accessor :options

    # date this customer begins their trial period
    attr_accessor :trial_start_date
    ...
    def self.attribute_map
      {
        ...
        :'products' => :'products',
        :'custom_plan_annual' => :'customPlanAnnual',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'billAddress')
        self.bill_address = attributes[:'billAddress']
      end
      ...
      if attributes.has_key?(:'stripeCustomerId')
        self.stripe_customer_id = attributes[:'stripeCustomerId']
      end

      if attributes.has_key?(:'salesforceAccountId')
        self.salesforce_account_id = attributes[:'salesforceAccountId']
      end
      ...
      if attributes.has_key?(:'customPlanAnnual')
        self.custom_plan_annual = attributes[:'customPlanAnnual']
      end
      ...
      if attributes.has_key?(:'nextInvoiceDate')
        self.next_invoice_date = attributes[:'nextInvoiceDate']
      end

      if attributes.has_key?(:'orgCount')
        self.org_count = attributes[:'orgCount']
      end

      if attributes.has_key?(:'headCount')
        self.head_count = attributes[:'headCount']
      end

      if attributes.has_key?(:'arr')
        self.arr = attributes[:'arr']
      end

      if attributes.has_key?(:'projectedArr')
        self.projected_arr = attributes[:'projectedArr']
      end
      ...
      if attributes.has_key?(:'trialStartDate')
        self.trial_start_date = attributes[:'trialStartDate']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ['ACTIVE', 'INACTIVE', 'TRIAL', 'CHURN', 'EXCLUDE'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ['ACTIVE', 'INACTIVE', 'TRIAL', 'CHURN', 'EXCLUDE'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          products == o.products &&
          custom_plan_annual == o.custom_plan_annual &&
          start_date == o.start_date &&
          end_date == o.end_date &&
          next_invoice_date == o.next_invoice_date &&
          org_count == o.org_count &&
          head_count == o.head_count &&
          arr == o.arr &&
          projected_arr == o.projected_arr &&
          options == o.options &&
    ...
    def hash
      [id, name, email, bill_address, industry, status, stripe_customer_id, salesforce_account_id, products, custom_plan_annual, start_date, end_date, next_invoice_date, org_count, head_count, arr, projected_arr, options, trial_start_date, trial_end_date, create_at, create_id, update_at, update_id].hash
    end
