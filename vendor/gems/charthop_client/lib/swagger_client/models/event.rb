...
module SwaggerClient
  class Event
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ['CREATE', 'UPDATE', 'DELETE', 'COMBINE', 'INVITE', 'UPDATE_PASSWORD', 'REMOVE_PASSWORD', 'DONE', 'ERROR', 'TOKEN', 'REQUEST', 'INCOMING', 'APPROVE', 'REJECT', 'REMIND', 'SYNC', 'STEP', 'RUN', 'SUBMIT', 'RESTORE', 'RESUME'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['CREATE', 'UPDATE', 'DELETE', 'COMBINE', 'INVITE', 'UPDATE_PASSWORD', 'REMOVE_PASSWORD', 'DONE', 'ERROR', 'TOKEN', 'REQUEST', 'INCOMING', 'APPROVE', 'REJECT', 'REMIND', 'SYNC', 'STEP', 'RUN', 'SUBMIT', 'RESTORE', 'RESUME'])
    ...
    def hash
      [id, user_id, org_id, type, entity_type, entity_id, table_id, subtype, payload, at].hash
    end
