...
module SwaggerClient
  class PartialGroup
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['LOCATION', 'DEPARTMENT', 'TEAM', 'BAND', 'JOBCODE'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['LOCATION', 'DEPARTMENT', 'TEAM', 'BAND', 'JOBCODE'])
    ...
    def hash
      [id, org_id, name, slug, code, aliases, type, lead_job_ids, fields, address, level, func, location_type, parent_group_id, timezone, comp_min, comp_max, image_path, color, create_id, create_at, update_id, update_at, delete_id, delete_at].hash
    end
