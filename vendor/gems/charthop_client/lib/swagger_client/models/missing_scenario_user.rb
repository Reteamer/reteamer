...
module SwaggerClient
  class MissingScenarioUser
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'roleSet')
        if (value = attributes[:'roleSet']).is_a?(Array)
          self.role_set = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @role_set.nil?
        invalid_properties.push('invalid value for "role_set", role_set cannot be nil.')
      end
    ...
    def hash
      [person_id, job_id, role_set].hash
    end
