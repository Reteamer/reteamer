...
module SwaggerClient
  class Template
    ...
    def valid?
      ...
      format_validator = EnumAttributeValidator.new('String', ['HTML', 'MARKDOWN', 'TEXT'])
    ...
    def format=(format)
      validator = EnumAttributeValidator.new('String', ['HTML', 'MARKDOWN', 'TEXT'])
    ...
    def hash
      [id, org_id, name, description, content, stylesheet, format, type, tags, filename, create_id, create_at, update_id, update_at, delete_id, delete_at].hash
    end
