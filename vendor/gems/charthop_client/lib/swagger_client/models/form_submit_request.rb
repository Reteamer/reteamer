...
module SwaggerClient
  class FormSubmitRequest
    ...
    def self.swagger_types
      {
        ...
        :'blocks_data' => :'Hash<String, Object>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'blocksData')
        if (value = attributes[:'blocksData']).is_a?(Hash)
          self.blocks_data = value
        end
      end
    end
    ...
    def hash
      [person_id, data, blocks_data].hash
    end
