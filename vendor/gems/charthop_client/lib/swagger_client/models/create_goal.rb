...
module SwaggerClient
  class CreateGoal
    ...
    # Use smart budget pools (beta)
    attr_accessor :budget_pools_enabled
    ...
    def self.attribute_map
      {
        ...
        :'budget_pools_enabled' => :'budgetPoolsEnabled',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'budgetPoolsEnabled')
        self.budget_pools_enabled = attributes[:'budgetPoolsEnabled']
      end
    ...
    def list_invalid_properties
      ...
      if @budget_pools_enabled.nil?
        invalid_properties.push('invalid value for "budget_pools_enabled", budget_pools_enabled cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @budget_pools_enabled.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          budget_pools_enabled == o.budget_pools_enabled &&
    ...
    def hash
      [label, slug, type, fields, results, parent_goal_id, owner_job_id, shared_job_ids, group_ids, share_access, sensitive, color, start_date, end_date, status, done_at, todo_count, todo_done_count, people_included_count, query, columns, locked_field_map, budget_pools, budget_pools_enabled, goal_options].hash
    end
