...
module SwaggerClient
  class Comment
    ...
    def valid?
      ...
      entity_type_validator = EnumAttributeValidator.new('String', ['SCENARIO', 'GOAL'])
    ...
    def entity_type=(entity_type)
      validator = EnumAttributeValidator.new('String', ['SCENARIO', 'GOAL'])
    ...
    def hash
      [id, org_id, entity_id, entity_type, content, create_at, create_id, delete_at, delete_id].hash
    end
