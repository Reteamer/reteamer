...
module SwaggerClient
  class Goal
    ...
    def hash
      [id, org_id, label, slug, type, fields, results, parent_goal_id, owner_job_id, shared_job_ids, group_ids, share_access, sensitive, color, start_date, end_date, status, done_at, todo_count, todo_done_count, people_included_count, query, create_id, create_at, update_id, update_at, delete_id, delete_at, columns, locked_field_map, budget_pools, budget_pools_enabled, goal_options].hash
    end
