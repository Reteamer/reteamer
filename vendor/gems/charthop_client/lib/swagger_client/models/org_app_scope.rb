...
module SwaggerClient
  class OrgAppScope
    ...
    def valid?
      ...
      scope_validator = EnumAttributeValidator.new('String', ['API_PROXY_READ', 'API_PROXY_READWRITE'])
    ...
    def scope=(scope)
      validator = EnumAttributeValidator.new('String', ['API_PROXY_READ', 'API_PROXY_READWRITE'])
