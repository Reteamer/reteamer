...
module SwaggerClient
  class SearchResultResponse
    ...
    def self.swagger_types
      {
        :'orgs' => :'Array<SearchResult>',
        :'customers' => :'Array<SearchResult>',
        :'jobs' => :'Array<SearchResult>',
        :'persons' => :'Array<SearchResult>',
        :'groups' => :'Array<SearchResult>',
        :'fields' => :'Array<SearchResult>',
        :'functions' => :'Array<SearchResult>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'persons')
        if (value = attributes[:'persons']).is_a?(Array)
          self.persons = value
        end
      end
    ...
    def hash
      [orgs, customers, jobs, persons, groups, fields, functions, users].hash
    end
