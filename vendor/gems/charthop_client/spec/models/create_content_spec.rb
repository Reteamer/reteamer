...
# Unit tests for SwaggerClient::CreateContent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateContent' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateContent.new
  end
  ...
  describe 'test an instance of CreateContent' do
    it 'should create an instance of CreateContent' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateContent)
    end
  end
