...
# Unit tests for SwaggerClient::PartialContent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartialContent' do
  before do
    # run before each test
    @instance = SwaggerClient::PartialContent.new
  end
  ...
  describe 'test an instance of PartialContent' do
    it 'should create an instance of PartialContent' do
      expect(@instance).to be_instance_of(SwaggerClient::PartialContent)
    end
  end
