...
# Unit tests for SwaggerClient::DataView
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DataView' do
  before do
    # run before each test
    @instance = SwaggerClient::DataView.new
  end
  ...
  describe 'test an instance of DataView' do
    it 'should create an instance of DataView' do
      expect(@instance).to be_instance_of(SwaggerClient::DataView)
    end
  end
