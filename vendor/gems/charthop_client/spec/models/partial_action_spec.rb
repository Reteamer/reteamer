...
# Unit tests for SwaggerClient::PartialAction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartialAction' do
  before do
    # run before each test
    @instance = SwaggerClient::PartialAction.new
  end
  ...
  describe 'test an instance of PartialAction' do
    it 'should create an instance of PartialAction' do
      expect(@instance).to be_instance_of(SwaggerClient::PartialAction)
    end
  end
