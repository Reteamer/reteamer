...
# Unit tests for SwaggerClient::PartialForm
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartialForm' do
  before do
    # run before each test
    @instance = SwaggerClient::PartialForm.new
  end
  ...
  describe 'test an instance of PartialForm' do
    it 'should create an instance of PartialForm' do
      expect(@instance).to be_instance_of(SwaggerClient::PartialForm)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["BUILT_IN", "CUSTOM"])
      # validator.allowable_values.each do |value|
