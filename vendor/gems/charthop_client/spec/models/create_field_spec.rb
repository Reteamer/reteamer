...
# Unit tests for SwaggerClient::CreateField
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateField' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateField.new
  end
  ...
  describe 'test an instance of CreateField' do
    it 'should create an instance of CreateField' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateField)
    end
  end
