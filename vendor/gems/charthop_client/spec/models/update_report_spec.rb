...
# Unit tests for SwaggerClient::UpdateReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateReport' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateReport.new
  end
  ...
  describe 'test an instance of UpdateReport' do
    it 'should create an instance of UpdateReport' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateReport)
    end
  end
