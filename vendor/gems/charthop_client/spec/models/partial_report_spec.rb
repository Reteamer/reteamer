...
# Unit tests for SwaggerClient::PartialReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartialReport' do
  before do
    # run before each test
    @instance = SwaggerClient::PartialReport.new
  end
  ...
  describe 'test an instance of PartialReport' do
    it 'should create an instance of PartialReport' do
      expect(@instance).to be_instance_of(SwaggerClient::PartialReport)
    end
  end
  ...
  describe 'test attribute "share"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["NORMAL", "FULL"])
