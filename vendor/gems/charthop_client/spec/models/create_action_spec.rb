...
# Unit tests for SwaggerClient::CreateAction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateAction' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateAction.new
  end
  ...
  describe 'test an instance of CreateAction' do
    it 'should create an instance of CreateAction' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateAction)
    end
  end
