...
# Unit tests for SwaggerClient::CreateReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateReport' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateReport.new
  end
  ...
  describe 'test an instance of CreateReport' do
    it 'should create an instance of CreateReport' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateReport)
    end
  end
