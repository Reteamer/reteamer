...
# Unit tests for SwaggerClient::UpdateDataView
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateDataView' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateDataView.new
  end
  ...
  describe 'test an instance of UpdateDataView' do
    it 'should create an instance of UpdateDataView' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateDataView)
    end
  end
