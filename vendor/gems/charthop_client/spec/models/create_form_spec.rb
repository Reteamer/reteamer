...
# Unit tests for SwaggerClient::CreateForm
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateForm' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateForm.new
  end
  ...
  describe 'test an instance of CreateForm' do
    it 'should create an instance of CreateForm' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateForm)
    end
  end
