...
# Unit tests for SwaggerClient::CategorySort
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CategorySort' do
  before do
    # run before each test
    @instance = SwaggerClient::CategorySort.new
  end
  ...
  describe 'test an instance of CategorySort' do
    it 'should create an instance of CategorySort' do
      expect(@instance).to be_instance_of(SwaggerClient::CategorySort)
    end
  end
