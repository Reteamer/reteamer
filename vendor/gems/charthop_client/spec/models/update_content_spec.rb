...
# Unit tests for SwaggerClient::UpdateContent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateContent' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateContent.new
  end
  ...
  describe 'test an instance of UpdateContent' do
    it 'should create an instance of UpdateContent' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateContent)
    end
  end
