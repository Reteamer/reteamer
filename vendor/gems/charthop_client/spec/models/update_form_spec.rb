...
# Unit tests for SwaggerClient::UpdateForm
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateForm' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateForm.new
  end
  ...
  describe 'test an instance of UpdateForm' do
    it 'should create an instance of UpdateForm' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateForm)
    end
  end
