module ReteamerApi
  class AssignmentsController < ApplicationController
    ...
    def create
      ...
      Entry.create(effective_at: effective_date, versionable: assignment)
    end
    ...
    def destroy
      effective_date = Date.parse(params[:effective_date])
      entry = Entry.find_for(effective_date, key: params[:key]).first
      Updater.deactivate(effective_date, entry)
    end
  end
end
