module ReteamerApi
  class PeopleController < ApplicationController
    ...
    def create
      ...
      if params[:team_key]
        Entry.create!(plan_name: params.fetch(:plan_name, "main"), effective_at: effective_date, versionable: Assignment.new(person_key: person_entry.key, team_key: params[:team_key]))
      end
    ...
    def destroy
      ...
      Entry.create(plan_name: params.fetch(:plan_name, "main"), active: false, effective_at: effective_date, key: params[:key], versionable: person)
    ...
    def update_supervisor
      ...
      Entry.create(plan_name: person_params.fetch(:plan_name, "main"),effective_at: effective_date, key: person_params[:key], versionable: person)
    end
    ...
    def update_team
      ...
      Entry.create(plan_name: params.fetch(:plan_name, "main"), effective_at: effective_date, key: person_params[:key], versionable: assignment)
    end
