...
export class TeamChart {
  ...
  render() {
    ...
    svg.patternify({
      ...
      .svg-chart-container .hidden {
        display: none;
      }
      
      .svg-chart-container .fake-root-node {
        opacity: 0;
      }
      
      .svg-chart-container .team-box {
        fill: white;
        stroke: lightgray;
        stroke-width: 1px;
      }

      .svg-chart-container .team-bar {
        fill: #6d9bb4;
        height: 10px;
      }

      .svg-chart-container .team-name {
        color: #111672;
        font-size: 20px;
        font-weight: bold;
        text-align: center;
      ...
      .svg-chart-container team-details {
        width: 100%;
      }

      .svg-chart-container team-member-count {
    
      }

      .svg-chart-container people-box {
        display: flex;
        flex-wrap: wrap;
        flex-direction: row;
      ...
      .svg-chart-container .active-drag .person-bar {
      ...
      .svg-chart-container .drop-target {
        filter: drop-shadow(3px 3px 2px rgba(33, 208, 28, 0.7));
      }
      
      .svg-chart-container .drop-not-allowed {
        filter: drop-shadow(3px 3px 2px rgba(208, 33, 28, 0.7));
      }
      
      .svg-chart-container .person-node {
        fill: none;
      ...
      .svg-chart-container .person-button {
        fill: #2b7bb9;
      }
      ...
      .svg-chart-container .person-node img {
        overflow: hidden;
      }
            
      .svg-chart-container .person-bar {
        height: 10px;
      }
      
      .svg-chart-container .person-bar.contractor {
        fill: #465298;
      }
      
      .svg-chart-container .person-bar.employee {
        fill: #3AB6E3;
      }
      
      .svg-chart-container .person-bar.openreq {
        fill: #74e776l;
      }
      
      .svg-chart-container person-info {
        padding: 20px;
        padding-top: 35px;
        text-align: center;
        display: block;
      ...
      .svg-chart-container .person-name {
        fill: #111672;
        font-size: 16px;
        font-weight: bold;
        display: block;
      ...
      .svg-chart-container .person-title {
        color: #404040;
        font-size: 16px;
        margin-top: 4px;
        display: block;
