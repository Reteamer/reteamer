...
def peopleOfThirtyRock(account)
  ActsAsTenant.with_tenant(account) do
    ...
    Assignments::Assignment.create(Date.current, person_id: jack.key, team_id: nbc.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: liz.key, team_id: tgs.proto_id)
    Assignments::Assignment.create(Date.current, person_id: liz.key, team_id: writers.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: pete.key, team_id: tgs.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: jon.key, team_id: nbc.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: kenneth.key, team_id: tgs.proto_id)
    Assignments::Assignment.create(Date.current, person_id: kenneth.key, team_id: entourage.proto_id)
    ...
    Assignments::Assignment.create(7.weeks.from_now.to_date, person_id: leo.key, team_id: nbc.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: tracy.key, team_id: actors.proto_id)
    Assignments::Assignment.create(Date.current, person_id: tracy.key, team_id: entourage.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: dotcom.key, team_id: entourage.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: grizz.key, team_id: entourage.proto_id)

    # Add a dotted line for Kenneth who is also part of Tracy's entourage
    errand_boy_connection = Connections::Connection.create(Date.current, person_id: kenneth.key, other_supervisor_id: tracy.key, label: "Errand Boy")
    ...
    Assignments::Assignment.create(Date.current, person_id: jenna.key, team_id: actors.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: josh.key, team_id: actors.proto_id)
    Assignments::Assignment.create(Date.current, person_id: josh.key, team_id: writers.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: frank.key, team_id: writers.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: lutz.key, team_id: writers.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: toofer.key, team_id: writers.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: cerie.key, team_id: tgs.proto_id)
    ...
    Assignments::Assignment.create(14.weeks.from_now, person_id: don.key, team_id: ge.proto_id)
    ...
    Assignments::Assignment.create(18.weeks.from_now.to_date, person_id: devon.key, team_id: nbc_west.proto_id)
    # end of season 1
    ...
    Assignments::Assignment.create(4.years.from_now.to_date, person_id: danny.key, team_id: actors.proto_id)
    ...
    Assignments::Assignment.create(5.years.from_now.to_date, person_id: hank.key, team_id: kabletown.proto_id)
