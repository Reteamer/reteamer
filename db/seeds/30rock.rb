...
def peopleOfThirtyRock(account)
  ...
  ActsAsTenant.with_tenant(account) do
    ActsAsProposable.with_proposal(Proposal.default_proposal) do
      ...
      # season 2
      Entry.create(effective_at: episodes[:s2e03], versionable: People::Contractor.create(first_name: "Lenny", last_name: "Wosniak", title: "Private Investigator", supervisor_key: jack.key, image_url: "/demo_avatars/30_rock/lenny.jpeg"))
