...
def peopleOfThirtyRock(account)
  ActsAsTenant.with_tenant(account) do
    ge      = Entry.create(effective_at: Date.current, versionable: Teams::Team.create(name: "General Electric"))
    nbc     = Entry.create(effective_at: Date.current, versionable: Teams::Team.create(name: "East Coast Television and Microwave Oven Programming", parent_key: ge.key))
    tgs     = Entry.create(effective_at: Date.current, versionable: Teams::Team.create(name: "The Girly Show (TGS)", parent_key: nbc.key))
    writers = Entry.create(effective_at: Date.current, versionable: Teams::Team.create(name: "Writers", parent_key: tgs.key))
    actors  = Entry.create(effective_at: Date.current, versionable: Teams::Team.create(name: "Actors", parent_key: tgs.key))
    entourage  = Entry.create(effective_at: Date.current, versionable: Teams::Team.create(name: "Tracy's Entourage", parent_key: actors.key))
    ...
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: jack.key, team_key: nbc.key))
    ...
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: liz.key, team_key: tgs.key))
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: liz.key, team_key: writers.key))
    ...
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: pete.key, team_key: tgs.key))
    ...
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: jon.key, team_key: nbc.key))
    ...
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: kenneth.key, team_key: tgs.key))
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: kenneth.key, team_key: entourage.key))
    ...
    Entry.create(effective_at: 7.weeks.from_now.to_date, versionable: Assignments::Assignment.create(person_key: leo.key, team_key: nbc.key))
    ...
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: tracy.key, team_key: actors.key))
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: tracy.key, team_key: entourage.key))
    ...
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: dotcom.key, team_key: entourage.key))
    ...
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: grizz.key, team_key: entourage.key))
    ...
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: jenna.key, team_key: actors.key))
    ...
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: josh.key, team_key: actors.key))
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: josh.key, team_key: writers.key))
    ...
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: frank.key, team_key: writers.key))
    ...
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: lutz.key, team_key: writers.key))
    ...
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: toofer.key, team_key: writers.key))
    ...
    Entry.create(effective_at: Date.current, versionable: Assignments::Assignment.create(person_key: cerie.key, team_key: tgs.key))
    ...
    Entry.create(effective_at: 14.weeks.from_now, versionable: Assignments::Assignment.create(person_key: don.key, team_key: ge.key))
    ...
    nbc_west = Entry.create(effective_at: 18.weeks.from_now.to_date, versionable: Teams::Team.create(name: "West Coast News, Web Content, and Theme Park Talent Relations", parent_key: ge.key))
    Entry.create(effective_at: 18.weeks.from_now.to_date, versionable: Assignments::Assignment.create(person_key: devon.key, team_key: nbc_west.key))
    # end of season 1
    ...
    Entry.create(effective_at: 4.years.from_now.to_date, versionable: Assignments::Assignment.create(person_key: danny.key, team_key: actors.key))
    ...
    kabletown = Entry.create(effective_at: 5.years.from_now.to_date, versionable: Teams::Team.create(name: "Kabletown"))
    ...
    Entry.create(effective_at: 5.years.from_now.to_date, versionable: Assignments::Assignment.create(person_key: hank.key, team_key: kabletown.key))
