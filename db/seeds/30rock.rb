...
def peopleOfThirtyRock(account)
  ActsAsTenant.with_tenant(account) do
    ...
    Assignments::Assignment.create(Date.current, person_id: jack.proto_id, team_id: nbc.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: liz.proto_id, team_id: tgs.proto_id)
    Assignments::Assignment.create(Date.current, person_id: liz.proto_id, team_id: writers.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: pete.proto_id, team_id: tgs.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: jon.proto_id, team_id: nbc.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: kenneth.proto_id, team_id: tgs.proto_id)
    Assignments::Assignment.create(Date.current, person_id: kenneth.proto_id, team_id: entourage.proto_id)
    ...
    Assignments::Assignment.create(7.weeks.from_now.to_date, person_id: leo.proto_id, team_id: nbc.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: tracy.proto_id, team_id: actors.proto_id)
    Assignments::Assignment.create(Date.current, person_id: tracy.proto_id, team_id: entourage.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: dotcom.proto_id, team_id: entourage.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: grizz.proto_id, team_id: entourage.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: jenna.proto_id, team_id: actors.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: josh.proto_id, team_id: actors.proto_id)
    Assignments::Assignment.create(Date.current, person_id: josh.proto_id, team_id: writers.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: frank.proto_id, team_id: writers.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: lutz.proto_id, team_id: writers.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: toofer.proto_id, team_id: writers.proto_id)
    ...
    Assignments::Assignment.create(Date.current, person_id: cerie.proto_id, team_id: tgs.proto_id)
    ...
    Assignments::Assignment.create(14.weeks.from_now, person_id: don.proto_id, team_id: ge.proto_id)

    jack = jack.update_with_date(14.weeks.from_now.to_date, supervisor_proto_id: don.proto_id)
    ...
    Assignments::Assignment.create(18.weeks.from_now.to_date, person_id: devon.proto_id, team_id: nbc_west.proto_id)
    # end of season 1
    ...
    # season 3
    josh = josh.update_with_date(4.years.from_now.to_date, active: false) # Josh leaves after season 3
    # end of season 3
    ...
    Assignments::Assignment.create(4.years.from_now.to_date, person_id: danny.proto_id, team_id: actors.proto_id)
    don = don.update_with_date(5.years.from_now.to_date, active: false) # Geiss dies
    jack = jack.update_with_date(5.years.from_now.to_date, supervisor_proto_id: nil)
    devon = devon.update_with_date(5.years.from_now.to_date, active: false)
    # end of season 4
    ...
    Assignments::Assignment.create(5.years.from_now.to_date, person_id: hank.proto_id, team_id: kabletown.proto_id)

    jack = jack.update_with_date(5.years.from_now.to_date, supervisor_proto_id: hank.proto_id)
    ...
    josh = josh.update_with_date(6.years.from_now.to_date, active: true) # Josh comes back for the season finale
