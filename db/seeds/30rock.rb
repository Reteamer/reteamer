...
def peopleOfThirtyRock(account)
  ...
  ActsAsTenant.with_tenant(account) do
    ...
    pete    = Entry.create(effective_at: episodes[:s1e01], versionable: People::Employee.create(employee_id: "NBC-386D3", first_name: "Pete", last_name: "Hornberger", title: "Producer", supervisor_key: jack.key, image_url: "/demo_avatars/30_rock/pete.png"))
    ...
    dotcom  = Entry.create(effective_at: episodes[:s1e01], versionable: People::Contractor.create(first_name: "Walter \"Dot Com\"", last_name: "Slattery", title: "Entrepreneur", supervisor_key: tracy.key))
    Entry.create(effective_at: episodes[:s1e01], versionable: Assignment.create(person_key: dotcom.key, team_key: entourage.key))

    grizz   = Entry.create(effective_at: episodes[:s1e01], versionable: People::Contractor.create(first_name: "Warren \"Grizz\"", last_name: "Griswald", title: "Talent Manager", supervisor_key: tracy.key))
    ...
    jenna   = Entry.create(effective_at: episodes[:s1e01], versionable: People::Employee.create(employee_id: "NBC-503Y2", first_name: "Jenna", last_name: "Maroney", title: "Actor", supervisor_key: liz.key, image_url: "/demo_avatars/30_rock/jenna.jpeg"))
    Entry.create(effective_at: episodes[:s1e01], versionable: Assignment.create(person_key: jenna.key, team_key: actors.key))

    josh    = Entry.create(effective_at: episodes[:s1e01], versionable: People::Employee.create(employee_id: "NBC-684N0", first_name: "Josh", last_name: "Girard", title: "Actor/Writer", supervisor_key: liz.key, image_url: "/demo_avatars/30_rock/josh.png"))
    ...
    frank   = Entry.create(effective_at: episodes[:s1e01], versionable: People::Employee.create(employee_id: "NBC-494T7", first_name: "Frank", last_name: "Rossitano", title: "Writer", supervisor_key: liz.key, image_url: "/demo_avatars/30_rock/frank.jpeg"))
    Entry.create(effective_at: episodes[:s1e01], versionable: Assignment.create(person_key: frank.key, team_key: writers.key))

    lutz    = Entry.create(effective_at: episodes[:s1e01], versionable: People::Employee.create(employee_id: "NBC-747S3", first_name: "Johnny", last_name: "Lutz", title: "Writer", supervisor_key: liz.key))
    Entry.create(effective_at: episodes[:s1e01], versionable: Assignment.create(person_key: lutz.key, team_key: writers.key))

    toofer  = Entry.create(effective_at: episodes[:s1e01], versionable: People::Employee.create(employee_id: "NBC-313V5", first_name: "Toofer", last_name: "Spurlock", title: "Writer", supervisor_key: liz.key))
    Entry.create(effective_at: episodes[:s1e01], versionable: Assignment.create(person_key: toofer.key, team_key: writers.key))

    cerie   = Entry.create(effective_at: episodes[:s1e01], versionable: People::Employee.create(employee_id: "NBC-8008S", first_name: "Cerie", last_name: "Xerox", title: "Assistant", supervisor_key: liz.key))
    Entry.create(effective_at: episodes[:s1e01], versionable: Assignment.create(person_key: cerie.key, team_key: tgs.key))

    don     = Entry.create(effective_at: episodes[:s1e14], versionable: People::Employee.create(employee_id: "GE-357R0", first_name: "Don", last_name: "Geiss", title: "CEO of General Electric", image_url: "/demo_avatars/30_rock/don.png"))
    ...
    # season 2
    lenny   = Entry.create(effective_at: episodes[:s2e03], versionable: People::Contractor.create(first_name: "Lenny", last_name: "Wosniak", title: "Private Investigator", supervisor_key: jack.key, image_url: "/demo_avatars/30_rock/lenny.jpeg"))
    ...
    danny   = Entry.create(effective_at: episodes[:s4e05], versionable: People::Employee.create(employee_id: "NBC-488P8", first_name: "Danny", last_name: "Baker", title: "Actor", supervisor_key: liz.key, image_url: "/demo_avatars/30_rock/danny.jpeg"))
    ...
    hank    = Entry.create(effective_at: episodes[:s5e13], versionable: People::Employee.create(employee_id: "KBL-001", first_name: "Hank", last_name: "Hooper", title: "CEO Kabletown", image_url: "/demo_avatars/30_rock/hank.png"))
    ...
    angie = Entry.create(effective_at: episodes[:s5e11], versionable: People::Contractor.create(first_name: "Angie", last_name: "Jordan", title: "Actor/Producer", supervisor_key: liz.key))
